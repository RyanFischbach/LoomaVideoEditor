...
$(document).ready(function () {
    ...
    var addedVideoArea = document.getElementById("overlaid-video-area");
			...
			if (commands.videoTimes[0] <= video.currentTime) {
				...
				if (commands.fileTypes[0] == "text") {
					...
					if (currentPlaybackImage != null) {
						document.getElementById("image-area").removeChild(currentPlaybackImageImage);
					}
